...
{
return (a.Get_X() - b.Get_X()); //subrtacting the x cordinates of a and b
}
int rectangle::side2() //function to find the length of each side
{
return (a.Get_Y()-d.Get_Y()); //substracting the y cordinates of a and d
}
float rectangle::area()
{
 return side1()*side2(); //multiplying both the sides
}
int main()
{               
	int x,y;
